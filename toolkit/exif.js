...
export async function mediaMessage(msg, filename, attachExtension = true) {
  try {
...
export const writeExifImg = (media, metadata, converted) => writeExif(media, metadata, false, converted);
export const writeExifVid = (media, metadata, converted) => writeExif(media, metadata, true, converted);
...
export async function sendImageAsSticker(conn, chatId, webpBuffer, msg) {
  try {
